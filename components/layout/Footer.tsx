        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            <Link href="/" className="inline-block mb-6">
              <span className="text-2xl font-bold tracking-tight text-blue-600">GB Construction</span>
            </Link>
            <p className="text-sm text-gray-600 mb-6 leading-relaxed">
              We build modern Scandinavian-style homes with clean lines, natural materials, and exceptional craftsmanship for discerning clients.
            </p>
            <div className="flex space-x-4">
              <Link href="#" className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 hover:bg-blue-100 transition-colors">
