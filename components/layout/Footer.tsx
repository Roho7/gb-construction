        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="mailto:info@gbconstruction.in" className="text-gray-400 hover:text-white">
          ...
          <div className="hidden lg:block">
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4">Direction and Office</h3>
            <Link href="/contact" className="text-gray-400 hover:text-white inline-flex items-center text-sm">
              View map
      ...
      <div className="border-t border-gray-800">
        <div className="container py-6">
          <p className="text-xs text-gray-400">
            © {new Date().getFullYear()} GB Construction | Terms of Use | Processing of Personal Data | Cookie Preferences
          </p>
        </div>
      </div>
    </footer>
