...
const statsData = [
  {
    ...
    label: "WATER PLANTS",
    description:
      "Water in water treatment plant is treated through physical processes for example filtration or settling and chemical processes such as coagulation and disinfection.",
  },
  {
    number: 47,
    label: "ALL PROJECTS",
    description:
      "We have completed end number of projects successfully and have become the preferred choice of various government and non-government organization.",
  },
];
                ...
                <div key={index} className="relative">
                  ...
                  <div
                    className={cn(
                      ...
                      index === 0
                        ? "top-0 right-0 w-32 h-32 bg-[hsl(210,100%,50%)]"
                        : "bottom-0 left-0 w-40 h-40 bg-[hsl(200,100%,45%)]",
                    )}
                  ></div>
                </div>
              ))}
